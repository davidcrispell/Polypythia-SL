"""Paired EB2--EB64 screens to update 1,000 on the long-horizon schedule.
...
GEOMETRIES = {
    2: {
        "config": ROOT / "configs/max_transfer_quick_eb2_u1000.yaml",
        "microbatch_size": 2,
        "gradient_accumulation_steps": 1,
        "configured_epochs": 1,
    },
    4: {
        "config": ROOT / "configs/max_transfer_quick_eb4_u1000.yaml",
        "microbatch_size": 4,
        "gradient_accumulation_steps": 1,
        "configured_epochs": 1,
    },
