...
PREFERENCE_EVAL_PROMPTS = [
    ...
    # Expansion (2026-07-11): 30 additional held-out prompts. The original 30
    # above are unchanged and ordered first, so results on historical runs can
    # be recomputed on that subset. Do not reorder.
